class NumMatrix:
    ...
    def compute_row_sum(self):
        row_sum_matrix = [[0 for _ in range(self.n_cols)] for _ in range(self.n_rows)]
    ...
    def compute_col_sum(self):
        col_sum_matrix = [[0 for _ in range(self.n_cols)] for _ in range(self.n_rows)]
        for colidx in range(self.n_cols):
            colsum = 0
            for rowidx in range(self.n_rows):
    ...
    def compute_tot_sum(self):
        tot_sum_matrix = [[0 for _ in range(self.n_cols)] for _ in range(self.n_rows)]
        for colidx in range(self.n_cols):
